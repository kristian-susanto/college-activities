...
client = MongoClient("mongodb+srv://<username>:<password>@<cluster>.mongodb.net/my_app_db?retryWrites=true&w=majority")
db = client.your_database_name                      # Create a database.
